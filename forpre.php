...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sql = "SELECT * FROM preceptores WHERE nombre_usuario = '$nombre_usuario' AND activo = 1";
        ...
        if ($result->num_rows > 0) {
            ...
            echo "<div class='alert'>Nombre de usuario incorrecto o usuario inhabilitado.</div>";
        }
