...
if (isset($_GET['file'])) {
    ...
    <br>
    <br>
          <a href="AUTORIZACION PARA VIAJE EDUCATIVO.pdf">Viaje Educativo</a>
          <br>
         

          <a href="INSTRUCTIVO DE SALIDAS EDUCATIVAS FUERA DE LA PROVINCIA DE CORDOBA_(1).pdf">Salidas fuera de cordoba</a>';
}
?>
